...
<%
	...
	Map<String, List<DtPrestamo>> prestamosPorZona = (Map<String, List<DtPrestamo>>) request.getAttribute("prestamosPorZona");
	...
	// Si no hay datos, inicializar mapa vacío
	if (prestamosPorZona == null) {
		prestamosPorZona = new java.util.LinkedHashMap();
	}
%>
...
<title>Préstamos por Zona - Lectores UY</title>
</head>
...
<body>
	...
	<div class="container mt-4">
		<div class="row">
			<div class="col-12">
				<h2 class="mb-4">
					<i class="fas fa-map-marker-alt text-primary"></i> Préstamos por Zona
				</h2>
				...
				<% if (prestamosPorZona.isEmpty()) { %>
					<div class="alert alert-info" role="alert">
						<i class="fas fa-info-circle"></i> No hay préstamos registrados por zona.
					</div>
				<% } else { %>
					<div class="alert alert-primary" role="alert">
						<i class="fas fa-info-circle"></i> Total de zonas con préstamos: <strong><%= prestamosPorZona.size() %></strong>
					</div>
					...
					<% for (Map.Entry<String, List<DtPrestamo>> entry : prestamosPorZona.entrySet()) { %>
						<% 
							...
							List<DtPrestamo> prestamos = entry.getValue();
						...
						<div class="card zona-card">
							<div class="zona-header">
								<div class="d-flex justify-content-between align-items-center">
									<h4 class="mb-0">
										<i class="fas fa-map-marker-alt"></i> <%= zona != null ? zona : "Sin Zona" %>
									</h4>
									<span class="stat-badge">
										<i class="fas fa-book-reader"></i> <%= prestamos.size() %> préstamo(s)
									</span>
								</div>
							</div>
							<div class="card-body">
								<% if (prestamos.isEmpty()) { %>
									<p class="text-muted mb-0">No hay préstamos registrados para esta zona.</p>
								<% } else { %>
					...
					<div class="card mt-4">
						<div class="card-body bg-light text-center">
							<h5 class="mb-0">
								<i class="fas fa-chart-bar text-primary"></i> Total de préstamos en todas las zonas: <strong><%= totalPrestamos %></strong>
							</h5>
						</div>
					</div>
				<% } %>
